...
class SingleFeaturesItemWidget extends StatelessWidget {
  final String futureName;
  final Color color;
  const SingleFeaturesItemWidget({
    Key? key,
  ...
  Widget build(BuildContext context) {
    return Padding(
      padding: EdgeInsets.only(left: SizeConfig.height*0.0,bottom: SizeConfig.height*0.02,),
      child: Row(

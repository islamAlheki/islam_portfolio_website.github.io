  ...
  Widget bottomTitleWidgets(double value, TitleMeta meta) {
    ...
    switch (value.toInt()) {
      case 2:
        text =  Column(
          children: [
            Text(
              ...
              style: Theme.of(IslamPortfolio.navigatorKey.currentState!.overlay!.context).textTheme.headline6!.copyWith(
        ...
        break;
      case 7:
        text = Text('Project’s', style: TextStyle(
        ...
        break;
      case 12:
        text = Text('Partner’s', style: TextStyle(
      ...
      child: Container(
        decoration: BoxDecoration(
          ...
          gradient: LinearGradient(
            colors: [
              Color(0xff2c274c).withOpacity(0.0),
              Color(0xff46426c).withOpacity(0.0),
            ],
